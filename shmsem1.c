...
/* Программа 1 для иллюстрации синхронизированного доступа к разделяемой памяти*/
...
int main()
{
    ...
    struct sembuf mybuf; // Буфер, содержащий информацию о выполнении операции над семафором
